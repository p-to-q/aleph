...
| [`kaggle-runbook.md`](kaggle-runbook.md) | Offline recovery of a completed legacy Kaggle run into a canonical detailed receipt, including strict identity, raw-output preservation, scalar replay, and blocked empty/near-cap diagnostics. |
